    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
        <li class="nav-item text-light">
          <a class="nav-link active text-light" aria-current="page" href="AdminLog.php">Log in as Admin</a>
        </li>
        <li class="nav-item text-light">
        ...
        <div class="card" style="border-radius: 1rem;">
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              ...
              <form action="EmployeLoginL.php" method="POST">
                ...
                <!-- Submit button -->
                <div class="pt-1 mb-4">
                    <button class="btn btn-dark btn-lg btn-block" type="submit" name="submit">Log In</button>
                </div>
